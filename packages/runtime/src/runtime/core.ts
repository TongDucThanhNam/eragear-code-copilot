...
} from "#runtime/bootstrap/composition";
import type { ServerRuntimePolicy } from "#runtime/bootstrap/server-runtime-policy";
...
class AppRuntimeCore implements RuntimeCore {
  ...
  health(): RuntimeHealth {
    ...
    return {
      ...
      message: ready
        ? "Runtime core is ready."
        : `Runtime core is ${this.state}.`,
    };
  }
