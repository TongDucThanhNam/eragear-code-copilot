import type { SessionSummary } from "#runtime/presentation/dashboard/dashboard-data";
...
export function SessionRow({
  ...
  return (
    <div
      className={`session-item card-enhanced stagger-item ${session.isActive ? "active" : ""}`}
    >
