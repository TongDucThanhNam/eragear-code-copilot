...
import { resolveAuthOAuthProvidersFromEnv } from "#runtime/platform/auth/oauth-providers";
import type {
  LogLevel,
  LogOutputFormat,
} from "#runtime/shared/types/log.types";
import {
...
import {
  ...
  DEFAULT_BACKGROUND_PROVIDER_QUOTA_RESET_DISPATCH_INTERVAL_MS,
...
export const ENV = {
  ...
  /** Interval for provider quota reset bot dispatch task in milliseconds */
  backgroundProviderQuotaResetDispatchIntervalMs: toPositiveInt(
    env.BACKGROUND_PROVIDER_QUOTA_RESET_DISPATCH_INTERVAL_MS,
    DEFAULT_BACKGROUND_PROVIDER_QUOTA_RESET_DISPATCH_INTERVAL_MS
  ),
