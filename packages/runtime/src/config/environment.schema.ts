...
export const envSchema = z.object({
  ...
  AUTH_OAUTH_GITHUB_CLIENT_ID: z.string().optional(),
  AUTH_OAUTH_GITHUB_CLIENT_SECRET: z.string().optional(),
  AUTH_OAUTH_GITHUB_SCOPES: z.string().optional(),
  AUTH_OAUTH_GOOGLE_CLIENT_ID: z.string().optional(),
  AUTH_OAUTH_GOOGLE_CLIENT_SECRET: z.string().optional(),
  AUTH_OAUTH_GOOGLE_SCOPES: z.string().optional(),
  AUTH_OAUTH_DISCORD_CLIENT_ID: z.string().optional(),
  AUTH_OAUTH_DISCORD_CLIENT_SECRET: z.string().optional(),
  AUTH_OAUTH_DISCORD_SCOPES: z.string().optional(),
  ...
  ERAGEAR_EMBEDDINGS_ENDPOINT: z.string().optional(),
  ERAGEAR_EMBEDDING_ENDPOINT: z.string().optional(),
  ERAGEAR_EMBEDDINGS_MODEL: z.string().optional(),
  ERAGEAR_EMBEDDING_MODEL: z.string().optional(),
  ERAGEAR_EMBEDDINGS_API_KEY: z.string().optional(),
  ERAGEAR_EMBEDDING_API_KEY: z.string().optional(),
  ERAGEAR_EMBEDDINGS_TIMEOUT_MS: z.string().optional(),
  ERAGEAR_EMBEDDING_TIMEOUT_MS: z.string().optional(),
  SUPERVISOR_ENABLED: z.string().optional(),
  SUPERVISOR_MODEL: z.string().optional(),
  MINIMAX_API_KEY: z.string().optional(),
  SUPERVISOR_DECISION_TIMEOUT_MS: z.string().optional(),
  SUPERVISOR_DECISION_MAX_ATTEMPTS: z.string().optional(),
  SUPERVISOR_MAX_RUNTIME_MS: z.string().optional(),
  SUPERVISOR_MAX_REPEATED_PROMPTS: z.string().optional(),
  SUPERVISOR_CUSTOM_SYSTEM_PROMPT: z.string().optional(),
  SUPERVISOR_TOOL_POLICY: z.string().optional(),
  SUPERVISOR_TOOL_ALLOWLIST: z.string().optional(),
  SUPERVISOR_WEB_SEARCH_PROVIDER: z.string().optional(),
  SUPERVISOR_WEB_SEARCH_API_KEY: z.string().optional(),
  EXA_API_KEY: z.string().optional(),
  SUPERVISOR_MEMORY_PROVIDER: z.string().optional(),
  SUPERVISOR_OBSIDIAN_COMMAND: z.string().optional(),
  SUPERVISOR_OBSIDIAN_VAULT: z.string().optional(),
  SUPERVISOR_OBSIDIAN_BLUEPRINT_PATH: z.string().optional(),
  SUPERVISOR_OBSIDIAN_LOG_PATH: z.string().optional(),
  SUPERVISOR_OBSIDIAN_SEARCH_PATH: z.string().optional(),
  SUPERVISOR_OBSIDIAN_SEARCH_LIMIT: z.string().optional(),
  SUPERVISOR_OBSIDIAN_TIMEOUT_MS: z.string().optional(),
  ...
  BACKGROUND_PROVIDER_QUOTA_RESET_DISPATCH_INTERVAL_MS: z.string().optional(),
  BACKGROUND_TASK_AUTO_ARCHIVE_INTERVAL_MS: z.string().optional(),
