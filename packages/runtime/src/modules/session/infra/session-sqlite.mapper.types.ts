import { z } from "zod";
import type { StoredMessage } from "#runtime/modules/session/domain/stored-session.types";
import type { sqliteSchema } from "#runtime/platform/storage/sqlite-db";
import type {
  SessionConfigOption,
  SessionModelState,
  SessionModeState,
} from "#runtime/shared/types/session.types";
import { isRecord as isRecordValue } from "#runtime/shared/utils/type-guards.util";
