// biome-ignore-all lint/suspicious/noMisplacedAssertion: Broker helper assertions validate shared test setup outside individual test bodies.
// biome-ignore-all lint/performance/useTopLevelRegex: Test stream parsing uses a local newline splitter for fixture readability.
