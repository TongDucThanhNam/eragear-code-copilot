...
import type { AgentRuntimePort } from "#runtime/modules/session";
...
} from "#runtime/shared/utils/process-termination.util";
import {
  isPosix,
  isWindows,
} from "#runtime/shared/utils/runtime-platform.util";
...
export class AgentRuntimeAdapter implements AgentRuntimePort {
  ...
  constructor(policy: AgentRuntimePolicy) {
    ...
    this.trafficProxyEnvironment =
      policy.trafficProxyEnvironment ?? (() => ({}));
  }
