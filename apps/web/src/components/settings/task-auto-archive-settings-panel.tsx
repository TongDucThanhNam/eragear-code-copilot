      ...
      {status ? (
        <div className="grid gap-4">
          ...
          >
            <span className="min-w-0">
              ...
              <span className="block text-muted-foreground text-xs">
                Stopped, unpinned tasks older than the configured threshold are archived.
              </span>
            </span>
            <Switch
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            />
            <Metric label="Threshold" value={`${status.settings.olderThanDays}d`} />
            <Metric
              label="Last archived"
          ...
          {status.lastRun ? (
            <div className="grid gap-2 rounded-md border bg-background p-3">
              ...
              <div className="grid gap-2 text-sm sm:grid-cols-2 lg:grid-cols-4">
                <Info label="Checked" value={formatDateTime(status.lastRun.checkedAt)} />
                <Info label="Inspected" value={String(status.lastRun.inspected)} />
                <Info label="Pinned" value={String(status.lastRun.skippedPinned)} />
                <Info label="Running" value={String(status.lastRun.skippedRunning)} />
                <Info label="Recent" value={String(status.lastRun.skippedRecent)} />
                <Info label="Already archived" value={String(status.lastRun.skippedArchived)} />
                <Info label="Failed" value={String(status.lastRun.failed)} />
                <Info label="Dry run" value={status.lastRun.dryRun ? "yes" : "no"} />
              </div>
