      ...
      {overview ? (
        <div className="grid gap-4">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Metric
              label="Needs trust"
              value={overview.lifecycle.needsTrust}
            />
            <Metric
              label="Marketplace"
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div className="truncate text-muted-foreground text-xs">
                            {schedule.pluginNames.join(", ") || schedule.presetId}
                          </div>
                        </div>
    ...
    <div className="grid gap-3 rounded-md border bg-background p-3 sm:grid-cols-[1fr_auto]">
      <div className="min-w-0">
        ...
        <div className="mt-2 flex flex-wrap gap-1">
          <Badge variant={plugin.trustStatus === "trusted" ? "outline" : "destructive"}>
    ...
    <div className="grid gap-3 rounded-md border bg-background p-3 lg:grid-cols-[1fr_auto]">
      <div className="min-w-0">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge
            variant={registry.trustStatus === "trusted" ? "secondary" : "destructive"}
          >
