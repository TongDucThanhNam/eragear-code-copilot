          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                ...
                {summary.head ? <Badge variant="outline">{summary.head}</Badge> : null}
              </div>
            </div>
            <Button
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 flex flex-wrap gap-1.5">
                        <Badge variant={checkpoint.kind === "auto" ? "secondary" : "outline"}>
                          {checkpoint.kind}
                        </Badge>
                        ...
                        {checkpoint.gitHead ? (
                          <Badge variant="outline">{checkpoint.gitHead.slice(0, 8)}</Badge>
                        ) : null}
                      </div>
                    </div>
                    <Button
