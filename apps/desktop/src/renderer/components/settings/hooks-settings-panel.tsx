...
type HookFailureMode =
  RouterOutput["hooks"]["list"]["lifecyclePolicy"]["failureMode"];
      ...
      action={
        ...
        >
          <RefreshCw
            className={cn(
              "mr-2 h-4 w-4",
              hooksQuery.isFetching ? "animate-spin" : ""
            )}
          />
          Refresh
        </Button>
    ...
    >
      <div className="grid gap-4">
        <div className="grid gap-3 rounded-md border bg-muted/20 p-3 lg:grid-cols-[1fr_240px]">
          ...
          <div className="flex min-w-0 flex-col justify-between gap-3 border-t pt-3 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-3">
