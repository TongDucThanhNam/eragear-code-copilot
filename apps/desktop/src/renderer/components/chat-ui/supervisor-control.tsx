...
function SupervisorStatusBadge({ status }: { status: SupervisorStatus }) {
  const isActive =
    status === "reviewing" || status === "continuing" || status === "queued";
          ...
          <div className="space-y-4 py-2">
            ...
            {status === "error" && reason && (
              <div className="rounded-lg border border-red-200 bg-red-50 p-3 dark:border-red-800 dark:bg-red-950/30">
                <p className="mb-1 font-medium text-red-800 text-sm dark:text-red-300">
                  Error Reason
                </p>
            ...
            {lastDecision && (
              <div className="rounded-lg border p-3">
                <p className="mb-1 font-medium text-sm">Last Decision</p>
