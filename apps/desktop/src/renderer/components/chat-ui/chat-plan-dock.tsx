...
export const ChatPlanDock = memo(
  function ChatPlanDock({ planSnapshot }: ChatPlanDockProps) {
    ...
    }, [planSnapshot?.toolCallId, planSnapshot]);
    ...
    const isStreaming = useMemo(() => {
      ...
      return planSnapshot.entries.some(
        (entry) => entry.status === "in_progress"
      );
    }, [planSnapshot?.entries]);
