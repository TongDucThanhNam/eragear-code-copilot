...
- Identify the tech stack (e.g. React, Next.js, Vue, Tailwind, shadcn/ui, Plain HTML, etc.).
...
## 0. Setup TailwindCSS v4 (if not already done)


- Tailwind v4; assume theme utilities like `bg-paper-cream`, `text-ink-primary` already mapped.
- - TailwindCSS v4 remove `tailwind.config.js` , We only need a css file/style (`type="text/tailwindcss"`) and import `@import "tailwindcss";`
